...
import CombinedGlLayer from "./CombinedGlLayer.js";
import { ShaderType } from "../util/util.js";

export default class CombinedLayer extends AbstractCustomLayer {
  ...
  private togglePlay(): void {
    ...
    async function updateDate(this: CombinedLayer): Promise<void> {
